...
class SourceEditor {
	...
	print("sourceEditorMain => ", editPanel, logPanel);
	splitter=wtag("splitter");
...
class EditorPanel {
	...
	@dev.editorEvent(editor);
	@dev.editorImpl(editor);
	@dev.editorImplKey(editor);
